AliAnalysisTaskPolarizationGeneral* AddPolarizationGeneral(const char* suffix = "")
{
...
AliAnalysisTaskPolarizationGeneral* task = new AliAnalysisTaskPolarizationGeneral(name.Data());
if(!task) return 0x0;
...
mgr->ConnectOutput(task,1,mgr->CreateContainer(fOutputListName.Data(), TList::Class(), AliAnalysisManager::kOutputContainer, fileName.Data()));
