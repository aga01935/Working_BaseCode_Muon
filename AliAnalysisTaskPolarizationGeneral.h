...
#ifndef AliAnalysisTaskPolarizationGeneral_H
#define AliAnalysisTaskPolarizationGeneral_H
...
class AliAnalysisTaskPolarizationGeneral : public AliAnalysisTaskSE
{
public:
                            AliAnalysisTaskPolarizationGeneral();
                            AliAnalysisTaskPolarizationGeneral(const char *name);
    virtual                 ~AliAnalysisTaskPolarizationGeneral();
 ...
 */
 ...
 //	Float_t fZNCEnergy;
  ...
  TH2F*                   fDeadZoneEtaVsPhiPerRunH[364];
  Double_t*               fEtaAndPhi;     //!
  //TH1D*                     fHistTriggers;
...
//	Int_t fCMUP;
  ...
  //Float_t                 fMCCollinPhi;
    ...
    AliAnalysisTaskPolarizationGeneral(const AliAnalysisTaskPolarizationGeneral&); // not implemented
    AliAnalysisTaskPolarizationGeneral& operator=(const AliAnalysisTaskPolarizationGeneral&); // not implemented

    ClassDef(AliAnalysisTaskPolarizationGeneral, 45);
};
