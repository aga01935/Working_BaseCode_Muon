 ...
 cout<<"running it locally"<<endl;
...
#if !defined (__CINT__) || defined (__CLING__)
    gInterpreter->LoadMacro("AliAnalysisTaskPolarizationGeneral.cxx++g");
    AliAnalysisTaskPolarizationGeneral *task = reinterpret_cast<AliAnalysisTaskPolarizationGeneral*>(gInterpreter->ExecuteMacro("AddPolarizationGeneral.C"));
#else
    gROOT->LoadMacro("AliAnalysisTaskPolarizationGeneral.cxx++g");
    gROOT->LoadMacro("AddPolarizationGeneral.C");
    AliAnalysisTaskPolarizationGeneral *task = AddPolarizationGeneral();
#endif
    ...
    cout<< "acutally running it on grid"<< endl;
       ...
       // chain->Add("/home/amrit/Analysis/TestCode/Histogram/AliAOD.root");
        chain->Add("/home/amrit/Analysis/MyTestCode2/AliAOD_UPCNano_18q_01.root");
	// start the analysis locally, reading the events from the tchain
      ...
      //  }
        ...
        alienHandler->SetAdditionalLibs("AliAnalysisTaskPolarizationGeneral.cxx AliAnalysisTaskPolarizationGeneral.h");
        alienHandler->SetAnalysisSource("AliAnalysisTaskPolarizationGeneral.cxx");
	...
	//alienHandler->SetDataPattern("*muon_calo_pass3/AOD225/PWGUD/UD_PbPb_AOD/501_20190723-1440/068/AliAOD.UPCNano.root");
	  ...
	  // MC has no prefix, data has prefix 000
        ...
        //TString LHC18q("LHC18q_histo");
        TString LHC18r("LHC18r_compare");
        TString LHC18q("LHC18q_compare");
       // TString LHC18q("LHC18q_compare");
        TString LHC15("LHC15_compare");
